		...
		lazyLoad: function() {
			...
			if( lazyLoadEl.length > 0 ) {
				lazyLoadEl.each( function(){
					...
					element.attr( 'src', '../parc-auto.html' ).css({ 'background': 'url(images/preloader.gif) no-repeat center center #FFF' });
		...
		twitterFeed: function(){
			...
			if( $twitterFeedEl.length > 0 ){
				$twitterFeedEl.each(function() {
					...
					if( !twitterFeedLoader ) { twitterFeedLoader = '../parc-auto.html'; }
